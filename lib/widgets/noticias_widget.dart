...
import 'package:soccer_cracks/services/notices_service.dart';
import 'package:soccer_cracks/widgets/noticias_card.dart';
  ...
  Widget build(BuildContext context) {
    ...
    if (_listaNotice!.isEmpty) {
     ...
     return Container(
      ...
      child: ListView(
        children: _listaNotice!
            .map((e) => NoticeCard(model: e))
            .toList(),
      ),
    );
  }
